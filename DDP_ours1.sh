set -v
dataset="NELL-995-subset-inductive" #FB15k-237-subset-inductive, NELL-995-subset-inductive, WN18RR-subset-inductive
suffix="_full"
...
# 10 DDP
CUDA_VISIBLE_DEVICES="0,1,2,3" python -m torch.distributed.launch --nproc_per_node 4 --master_port 12345 DDP.py \
 --device $device --epochs $epochs --batch_size 8 \
 ...
 --merge_max_path_num 3 --AP_load_setting ours\
